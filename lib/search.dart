...
class _SearchState extends State<Search> {
  ...
  Future<List> getData() async {
    ...
    http.get(url+"/$search_by/${_inputController.text}")
        .then((response) {
      save=response.body;
    });
    if (save==null){
             ...
             Container(
                  ...
                  child: Stack(alignment: Alignment.centerLeft ,
                    children: [
                      ...
                      Positioned(left: w*.79,
                        child: Tooltip(message: "Scan By Camera",
                          child: Container(
                          width:30 ,
                      ...
                      Positioned(   width:50 ,
                        left: w*.88,child: Tooltip(message:"Scan from  Gallery",
                          child: Container(
                            decoration: BoxDecoration(
                              color: Colors.transparent,
                        ...
                        child: Container(
                          ...
                          child:  FloatingActionButton.extended(
                            ...
                            onPressed: () => Navigator.push(
                                context, MaterialPageRoute(builder: (context1) => Add_Product())),
                          ),
                          decoration: BoxDecoration(
